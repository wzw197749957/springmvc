...
public class WzwDispatcherServlet extends HttpServlet {
    ...
    private void initHandlerMapping() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            if (!aClass.isAnnotationPresent(WzwController.class)) {
                continue;
            }
    ...
    private void doAutoWired() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            for (int i = 0; i < declaredFields.length; i++) {
                ...
                if (!declaredField.isAnnotationPresent(WzwAutowired.class)) {
                    continue;
                }


                // 有该注解
                WzwAutowired annotation = declaredField.getAnnotation(WzwAutowired.class);
    ...
    private void doInstance() {
        ...
        try {
            ...
            for (int i = 0; i < classNames.size(); i++) {
                ...
                } else if (aClass.isAnnotationPresent(WzwService.class)) {
                    WzwService annotation = aClass.getAnnotation(WzwService.class);
                    //获取注解value值
